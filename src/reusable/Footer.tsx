...
const Footer=()=> {
  ...
  return (
    <footer className="flex flex-col items-center gap-5 p-5 lg:flex-row lg:justify-between lg:p-12">
        ...
        <img src={TwiiterIcon} alt="Twitter" className="w-6 h-6 hover:cursor-pointer" />
        <img src={LinkedinIcon} alt="LinkedIn" className="w-6 h-6 hover:cursor-pointer" />
        <img src={GithubIcon} alt="Github" className="w-6 h-6 hover:cursor-pointer" />
        </div>
